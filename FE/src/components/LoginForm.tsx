  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6">
        ...
        <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-[#444]">
          <span className="bg-gray-950 text-[#ccc] relative z-10 px-2">
            Or continue with
          </span>
        </div>
        <Button
          variant="outline"
          className="w-full border-[#444] bg-[#2a2a2a] text-[#ccc] hover:text-[#ccc] cursor-pointer hover:bg-[#3a3a3a]"
        >
